...
const section1: Section = {
  ...
  questions: [
        ...
        },
        {
          ...
          options: [
            ...
            },
            {
              id: "c",
              label:
                "للدّلالة على كثرة الجماهير وامتدادها الواسع وتناسق تمايلها، ولجعل المشهد لوحة فنّيّة نابضة بالحيويّة والجمال، وتكسب النّصّ إيحاءً وتأثيرًا.",
              correct: true,
            },
          ],
        },
    ...
    },
    {
      ...
      type: "single",
      prompt:
        "حدّد المعنى الّذي قصده الكاتب في الجملة الآتية: «ويودع الكرة في جوف السّلّة المنافسة» (الفقرة الخامسة).",
      options: [
  ...
  questions: [
    {
      ...
      prompt: "عُد إلى النّصّ ثمّ صحّح الأخطاء الواردة في الجمل الآتية:",
    ...
    },
    {
      id: "g2",
      type: "freeText",
      prompt: "أعد كتابة ما يلي بصيغة المفرد، وحرّك:",
      context:
    ...
    },
    {
      id: "g5",
      type: "freeText",
      prompt: "صحّح الأخطاء الواردة في المقطع الآتي:",
      context:
        "عاد اللاعبين من المباراة فرحين، فهنّأهم المسؤولين، ثم راحوا يقيموا لهم الجوائز القيّمة. أمّا لاعبوا الفريق الآخر فقد عادوا مخذولون، ولم يحظون سوى بالخيبة.",
      expected:
        "عاد اللاعبون من المباراة فرحين، فهنّأهم المسؤولون، ثم راحوا يقيمون لهم الجوائز القيّمة. أمّا لاعبو الفريق الآخر فقد عادوا مخذولين، ولم يحظوا سوى بالخيبة.",
      maxPoints: 6,
    },
    {
      id: "g6",
      type: "tokenCorrection",
      prompt:
        "اضبط بالحركات المناسبة أواخر الكلمات في المقطع الآتي. اكتب كلّ كلمة مضبوطة بالحركات في حقلها:",
      context:
      ...
      subs: [
        ...
        },
        {
          ...
          options: [
            ...
            { id: "b", label: "متوسّطة مسبوقة بحرف مدّ" },
            {
              id: "c",
    ...
    },
    {
      id: "g11",
      type: "freeText",
      prompt: "صحّح الأخطاء الإملائيّة الواردة في المقطع الآتي:",
      context:
