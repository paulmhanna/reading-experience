...
export const lessonAudio: Record<number, ChunkAudio> = {
  1: {
    ...
    fadeOut: 0.8,
    cues: [
      { time: 10, effect: sfx("footsteps.mp3"), volume: 0.2, stopAfter: 4 },
      //{ time: 6.5, effect: sfx("crowd-loud.mp3"), volume: 0.5, stopAfter: 6 },
    ],
  },
  2: {
    narration: nar("chunk-2.mp4"),
    ambience: sfx("crowd-soft.mp3"),
    ambienceVolume: 0.03,
    ambienceLoop: true,
    fadeIn: 0.5,
    fadeOut: 0.8,
    cues: [
      //{ time: 30, effect: sfx("crowd-loud.mp3"), volume: 0.02, stopAfter: 3 },
      //{ time: 7, effect: sfx("anthem-swell.mp3"), volume: 0.55, stopAfter: 8 },
      //{ time: 14, effect: sfx("flags-whoosh.mp3"), volume: 0.6, stopAfter: 4 },
      { time: 18, effect: sfx("clap-burst.mp3"), volume: 0.2, stopAfter: 15 },
    ],
  },
  3: {
    narration: nar("chunk-3.mp4"),
    ambience: sfx("tension-loop.mp3"),
    ambienceVolume: 0.4,
    ambienceLoop: true,
    cues: [
      { time: 0.8, effect: sfx("whistle.mp3"), volume: 0.85 },
  ...
  4: {
    ...
    cues: [
      ...
      { time: 20, effect: sfx("tension-loop.mp3"), volume: 0.3, stopAfter: 6 },
    ],
  },
  5: {
    narration: nar("chunk-5.mp4"),
    ambience: sfx("tension-loop.mp3"),
    ambienceVolume: 0.3,
    ambienceLoop: true,
    cues: [
      ...
      { time: 30, effect: sfx("clap-burst.mp3"), volume: 0.2, stopAfter: 17 },
      { time: 39, effect: sfx("final-shout.mp3"), volume: 1.2, stopAfter: 6 },
    ],
  },
  6: {
    narration: nar("chunk-6.mp4"),
    ...
    cues: [
      ...
      { time: 20, effect: sfx("clap-burst.mp3"), volume: 0.1, stopAfter: 10 },
      { time: 22, effect: sfx("final-shout.mp3"), volume: 0.7, stopAfter: 6 },
    ],
  },
};
