import { Volume2, VolumeX, Play, Pause, RotateCcw, ChevronRight, ChevronLeft, Gauge, Mic, Music, Sparkles } from "lucide-react";
...
function VolumeSlider({
  ...
  return (
    <div className="flex items-center gap-3 bg-secondary/30 rounded-xl px-3 py-2">
      ...
      <Slider
        ...
        dir="ltr"
      />
      <span className="text-xs text-muted-foreground w-8 text-left">{Math.round(value * 100)}</span>
    </div>
  );
}
